...
public class MainActivity extends AppCompatActivity {
    ...
    com.ermawatisetianingsih.rumahmakanlomboktimur.DaftarRumahMakanAdapter adapter;
    ...
    private void setupListview() {
        adapter = new com.ermawatisetianingsih.rumahmakanlomboktimur.DaftarRumahMakanAdapter(this, daftarTransaksi);
    ...
    private void bukaFormTambahTransaksi() {
        Intent intent = new Intent(MainActivity.this, com.ermawatisetianingsih.rumahmakanlomboktimur.FormRumahMakanActivity.class);
